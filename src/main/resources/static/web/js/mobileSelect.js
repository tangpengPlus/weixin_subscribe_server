...
//			var cancelText = cancelBtnText ? cancelBtnText : '取消';
			var ensureText = ensureBtnText ? ensureBtnText : '完成';
			...
			_this.mobileSelect.innerHTML =
		        ...
		        '<div class="content">'+
		            '<div class="btnBar">'+
		                '<div class="fixWidth">'+
		                    '<div class="cancel">'+ '<img src="/web/img/jian1.png"/><img src="/web/img/jian2.png"/>' +'</div>'+
		                    '<div class="title"></div>'+
		...
		fixRowStyle: function(){
			var _this = this;
			var width = (100/_this.wheel.length).toFixed(4);
			for(var i=0; i<_this.wheel.length; i++){
