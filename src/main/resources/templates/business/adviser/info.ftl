                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">置业顾问姓名</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "accAdviserBase.name",'class="form-control"'/]
                                      </div>
                                 ...
                                 <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">置业顾问电话号码</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "accAdviserBase.phone",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                   		    <span>请输入正确的电话号码格式如13896667100</span>
                                            [@spring.showErrors /]
                                      </div>
                                  </div>
                                  
                                   [@spring.formInput "accAdviserBase.id", "", "hidden"/]
                                   <div class="form-group">
