              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
                          [@shiro.hasPermission name="/business/goods/add"]
                              <div class="btn-group">
                                  <a id="editable-sample_new" class="btn btn-primary" href="${base}/business/goods/add">
                                ...
                                <table class="table table-bordered table-striped table-condensed cf">
                                  ...
                                  [#if goodsList?? ]
	                                  [#list goodsList as goods]
	                                   <tr>
	                                      <td>${goods.id}</td>
	                                      <td class="numeric">${goods.name}</td>
	                                      <td class="numeric">${goods.price}</td>
	                                      <td class="numeric">
	                                      [@shiro.hasPermission name="/business/goods/update"]<a type="button" href="${base}/business/goods/update?id=${goods.id}" class="btn btn-danger btn-sm"><i class="icon-refresh"></i> Update</a>[/@shiro.hasPermission]
	                                      &nbsp;&nbsp;[@shiro.hasPermission name="/business/goods/delete"]<a type="button" href="${base}/business/goods/delete?id=${goods.id}" class="btn btn-warning btn-sm"><i class=" icon-trash"></i> Delete</a>[/@shiro.hasPermission]
	                                      </td>
	                                  </tr>
	                                  [/#list]
                                  [/#if]
