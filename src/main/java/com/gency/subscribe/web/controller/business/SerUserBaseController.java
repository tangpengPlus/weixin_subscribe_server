...
@Controller
@RequestMapping(value="/business/serUser")
public class SerUserBaseController {
	...
	public ModelAndView list(PageBean pb,ModelAndView mv){
		try {
				 mv.addObject("serUserList",serUserBaseService.selectListPage(pb, null));
				 mv.addObject("pagebean",pb);
				 mv.setViewName("business/seruser/list");
		} catch (Exception e) {
			e.printStackTrace();
		}
